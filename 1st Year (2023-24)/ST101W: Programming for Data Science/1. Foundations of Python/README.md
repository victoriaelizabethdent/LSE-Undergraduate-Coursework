[![Review Assignment Due Date](https://classroom.github.com/assets/deadline-readme-button-24ddc0f5d75046c5622901739e7c5dd533143b0c8e959d652212380cedb1ea36.svg)](https://classroom.github.com/a/-IEi0-qA)
...
This Problem set consists of 3 programming problems (with Q3 a continuation of Q2):

- Q1. [q1.md](q1.md) (40 marks)
- Q2. [q2.md](q2.md) (30 marks)
- Q3. [q3.md](q3.md) (30 marks)

The maximum mark you can get from this problem set is 100.

- **Submission deadline: 26 February 2024 12noon**
  - Any work submitted after the deadline will be penalised
- **Cut-off: 29 February 2024 12noon**
...
1. Submit your work (`.py` for code and `.md` files with textual answers) via GitHub
...
- Misconduct can lead to a zero for the entire coursework element or more serious consequences
  - Sharing your work with others also counts as misconduct
...
- Your submission must be solely the work of your group. It means that (_unless_ you are told otherwise / you have got permission from the lecturer):
  ...
  - You _cannot_ use
    - Any modules or libraries (unless it is stated otherwise in the question)
      - Even for modules that we have covered like `datetime` and `math`, you are _not_ allowed to use them _unless it is stated otherwise in the question_
        - For Q2 you can use `datetime` as it is stated in the question
...
| Problem-solving          | Apply computation thinking to solve problems. Outline how to use decomposition to solve a relatively complex problem                                                |
...
|                          | Select the right container for the problem at hand. Good explanation for the selection choice                                                                       |
...
| Analysis                 | Investigate and discuss the results of the program to get insights from the data                                                                                    |
...
|        | Good readability and style, with excellent program design                                                                                                                |
...
|        | Poor analysis: no attempt or not sensible                                                                                                                                |
