[![Review Assignment Due Date](https://classroom.github.com/assets/deadline-readme-button-24ddc0f5d75046c5622901739e7c5dd533143b0c8e959d652212380cedb1ea36.svg)](https://classroom.github.com/a/MlvhR6UV)
...
This Problem set consists of 3 programming problems:

- Q1. [src/simulation.ipynb](src/simulation.ipynb) (10 marks)
- Q2. [src/lse_students.ipynb](src/lse_students.ipynb) (25 marks)
- Q3a. [src/collage.ipynb](src/collage.ipynb) (55 marks)
...
- **Submission deadline: 14 March 2024 12noon**
  - Any work submitted after the deadline will be penalised
- **Cut-off: 17 March 2024 12noon**
  ...
  - You _cannot_ use
    - Any modules or libraries (unless it is stated otherwise in the question)
      - Even for modules that we have covered like `datetime` and `random`, you are _not_ allowed to use them _unless it is stated otherwise in the question_
        ...
        - For Q3 part 3, you can use `datetime` or `time` as it is stated in the question
...
|                              | Use assertion to check the internal logic of functions _appropriately_                                                                                              |
|                              | No unnecessary code, for example, comment-out code, unnecessary printouts, etc                                                                                      |
| Testing                      | Appropriate use of testing to ensure the code works as intended                                                                                                     |
